...
describe('OpenAPI document', () => {
  test('writes the OpenAPI JSON document', async () => {
    ...
    expect(document.paths).toHaveProperty('/adminCommunityRole/create')
    expect(document.paths).toHaveProperty('/adminOrganization/addMember')
    expect(document.paths).toHaveProperty('/adminOrganization/list')
    expect(document.paths).toHaveProperty('/adminUser/create')
    expect(document.paths).toHaveProperty('/adminUser/linkDiscordAccount')
    expect(document.paths).toHaveProperty('/adminUser/linkSolanaWallet')
    expect(document.paths).toHaveProperty('/core/status')
  })
})
